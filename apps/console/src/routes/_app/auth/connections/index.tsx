  ...
  return (
    <div className="flex min-w-0 flex-col gap-6">
      ...
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <ConnectionCard to="/auth/connections/saml" title={t("connections.cards.saml2Title")} description={t("connections.cards.saml2Desc")} />
        <ConnectionCard to="/auth/connections/saml-idp" title={t("connections.cards.samlIdpTitle")} description={t("connections.cards.samlIdpDesc")} />
        <ConnectionCard to="/auth/connections/oidc" title={t("connections.cards.oidcTitle")} description={t("connections.cards.oidcDesc")} />
        <ConnectionCard to="/auth/connections/scim" title={t("connections.cards.scimTitle")} description={t("connections.cards.scimDesc")} />
      </div>
    ...
    <li className="flex items-center justify-between gap-4 py-3">
      <div className="min-w-0">
        ...
        <p className="truncate text-xs text-muted-foreground">
          {t("connections.portal.linkExpires", { date: new Date(l.expires_at).toLocaleString() })}
          {l.last_used_at
            ? t("connections.portal.linkLastUsed", { date: new Date(l.last_used_at).toLocaleString() })
