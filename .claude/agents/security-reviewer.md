...
- **Crypto & secrets:** no secrets in code/logs/responses; correct use of `platform/tokens`/`password`/hashing; constant-time compares for tokens; no `*.pem`/keys committed.
