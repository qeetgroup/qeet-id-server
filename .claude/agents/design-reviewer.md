...
- `apps/console` — Vite + TanStack Router admin UI (`@qeet-id/console`, `pnpm dev:admin` → :3002)
- `apps/login` — Next.js hosted login (`@qeet-id/login`, `pnpm dev:login` → :3004)
- `apps/website` — Next.js marketing (`@qeet-id/web`, `pnpm dev:web` → :3001). React 19 throughout.
...
- **Run it:** `pnpm dev:admin|dev:login|dev:web`, exercise the flow, resize, toggle dark mode.
