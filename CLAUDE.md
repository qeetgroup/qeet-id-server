...
- **Migrations** — golang-migrate pairs **0001–0064** in [platform/database/migrations/](platform/database/migrations/) (latest `0064_rate_limit_overrides`; go **1.25.0**). Never edit an applied migration — add a new pair.
