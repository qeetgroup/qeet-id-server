...
import (
	...
	"github.com/qeetgroup/qeet-id-server/domains/access/authorization/abac"
	"github.com/qeetgroup/qeet-id-server/domains/access/authorization/authpolicy"
	"github.com/qeetgroup/qeet-id-server/domains/access/authorization/authzen"
	"github.com/qeetgroup/qeet-id-server/domains/access/authorization/policy"
	...
	"github.com/qeetgroup/qeet-id-server/domains/access/mfa"
	"github.com/qeetgroup/qeet-id-server/domains/access/passkeys"
	"github.com/qeetgroup/qeet-id-server/domains/access/recovery"
	"github.com/qeetgroup/qeet-id-server/domains/access/risk/ipallow"
	...
	"github.com/qeetgroup/qeet-id-server/domains/access/threat-detection/threat"
	"github.com/qeetgroup/qeet-id-server/domains/developer/agents"
	"github.com/qeetgroup/qeet-id-server/domains/developer/api-keys"
	"github.com/qeetgroup/qeet-id-server/domains/developer/auth-hooks"
	"github.com/qeetgroup/qeet-id-server/domains/developer/credentials/secrets"
	"github.com/qeetgroup/qeet-id-server/domains/developer/credentials/tokenvault"
	"github.com/qeetgroup/qeet-id-server/domains/developer/credentials/vc"
	"github.com/qeetgroup/qeet-id-server/domains/developer/service-accounts"
	...
	"github.com/qeetgroup/qeet-id-server/domains/federation/ldap"
	...
	"github.com/qeetgroup/qeet-id-server/domains/federation/social"
	"github.com/qeetgroup/qeet-id-server/domains/identity/domains"
	"github.com/qeetgroup/qeet-id-server/domains/identity/groups"
	"github.com/qeetgroup/qeet-id-server/domains/identity/invitations"
	"github.com/qeetgroup/qeet-id-server/domains/identity/organizations"
	...
	"github.com/qeetgroup/qeet-id-server/domains/identity/verification"
	"github.com/qeetgroup/qeet-id-server/domains/operations/activity"
	"github.com/qeetgroup/qeet-id-server/domains/operations/analytics"
	...
	"github.com/qeetgroup/qeet-id-server/domains/operations/billing"
	"github.com/qeetgroup/qeet-id-server/domains/operations/compliance"
	"github.com/qeetgroup/qeet-id-server/domains/operations/copilot"
	"github.com/qeetgroup/qeet-id-server/domains/operations/email-templates"
	"github.com/qeetgroup/qeet-id-server/domains/operations/notifications"
	"github.com/qeetgroup/qeet-id-server/domains/operations/ratelimits"
	"github.com/qeetgroup/qeet-id-server/domains/operations/retention"
	"github.com/qeetgroup/qeet-id-server/domains/operations/search"
	...
	httpapi "github.com/qeetgroup/qeet-id-server/platform/api/rest"
	...
	dbmigrations "github.com/qeetgroup/qeet-id-server/platform/database/migrations"
	...
	"github.com/qeetgroup/qeet-id-server/platform/observability/health"
	"github.com/qeetgroup/qeet-id-server/platform/observability/logging"
	"github.com/qeetgroup/qeet-id-server/platform/observability/metrics"
	"github.com/qeetgroup/qeet-id-server/platform/observability/tracing"
